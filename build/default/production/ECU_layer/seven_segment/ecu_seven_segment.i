...
# 13 "ECU_layer/seven_segment/../../MCAL_layer/GPIO/../compiler.h"
...
# 15 "ECU_layer/seven_segment/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 16 "ECU_layer/seven_segment/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 29 "ECU_layer/seven_segment/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum
{
    GPIO_PIN0 =0,
    GPIO_PIN1 ,
...
# 13 "ECU_layer/seven_segment/ecu_seven_segment.h" 2
...
# 9 "ECU_layer/seven_segment/ecu_seven_segment.c" 2
...
Std_ReturnType initialize_seven_segment(const segment_t *segment)
{
    ...
    {
        ret = gpio_pin_initialize(&(segment->segment[0]));
        ret = gpio_pin_initialize(&(segment->segment[1]));
        ret = gpio_pin_initialize(&(segment->segment[2]));
        ret = gpio_pin_initialize(&(segment->segment[3]));

    }
    return ret;
}
# 44 "ECU_layer/seven_segment/ecu_seven_segment.c"
Std_ReturnType seven_segment_write_number(const segment_t *segment,uint8 number)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    ...
    {
        ret = gpio_pin_write_logic(&(segment->segment[0]),(number & 0x01));
        ret = gpio_pin_write_logic(&(segment->segment[1]),((number >>1)& 0x01));
        ret = gpio_pin_write_logic(&(segment->segment[2]),((number >>2) & 0x01));
        ret = gpio_pin_write_logic(&(segment->segment[3]),((number >>3) & 0x01));
