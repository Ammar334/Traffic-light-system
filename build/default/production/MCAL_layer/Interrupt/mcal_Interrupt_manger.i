...
# 47 "MCAL_layer/Interrupt/mcal_Interrupt_manger.c"
void __attribute__((picinterrupt(("")))) Interrupt_manager(void)
{

    if((INTCONbits.INT0IE == 1)&&(INTCONbits.INT0F == 1))
    {
        INT0_ISR();
    }
    else
    { }
    if((INTCON3bits.INT1IE == 1)&&(INTCON3bits.INT1F == 1))
    {
        INT1_ISR();
    }
    else
    ...
    if((INTCONbits.RBIE == 1)&&(INTCONbits.RBIF == 1)&&(PORTBbits.RB4 == GPIO_HIGH)&&(RBx_flag[0] == 0))
    {
        RBx_flag[0] = 1;
        RB4_ISR(0);
    }
    ...
    { }
    if((INTCONbits.RBIE == 1)&&(INTCONbits.RBIF == 1)&&(PORTBbits.RB4 == GPIO_LOW)&&(RBx_flag[0] == 1))
    {
        RBx_flag[0] = 0;
        RB4_ISR(1);
    }
    ...
    { }
    if((INTCONbits.RBIE == 1)&&(INTCONbits.RBIF == 1)&&(PORTBbits.RB5 == GPIO_HIGH)&&(RBx_flag[1] == 0))
    {
        RBx_flag[1] = 1;
        RB5_ISR(0);
    }
    ...
    { }
    if((INTCONbits.RBIE == 1)&&(INTCONbits.RBIF == 1)&&(PORTBbits.RB5 == GPIO_LOW)&&(RBx_flag[1] == 1))
    {
        RBx_flag[1] = 0;
        RB5_ISR(1);
    }
    ...
    { }
    if((INTCONbits.RBIE == 1)&&(INTCONbits.RBIF == 1)&&(PORTBbits.RB6 == GPIO_HIGH)&&(RBx_flag[2] == 0))
    {
        RBx_flag[2] = 1;
        RB6_ISR(0);
    }
    ...
    { }
    if((INTCONbits.RBIE == 1)&&(INTCONbits.RBIF == 1)&&(PORTBbits.RB6 == GPIO_LOW)&&(RBx_flag[2] == 1))
    {
        RBx_flag[2] = 0;
        RB6_ISR(1);
    }
    ...
    { }
    if((INTCONbits.RBIE == 1)&&(INTCONbits.RBIF == 1)&&(PORTBbits.RB7 == GPIO_HIGH)&&(RBx_flag[3] == 0))
    {
        RBx_flag[3] = 1;
        RB7_ISR(0);
    }
    ...
    { }
    if((INTCONbits.RBIE == 1)&&(INTCONbits.RBIF == 1)&&(PORTBbits.RB7 == GPIO_LOW)&&(RBx_flag[3] == 1))
    {
        RBx_flag[3] = 0;
        RB7_ISR(1);
    }
