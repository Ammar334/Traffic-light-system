...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((pin==((void*)0))||(pin->pin>=8)||(dir_status==((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
    {
        *dir_status = ((*tris_registers[pin->port] >> pin->pin) & (uint8)1);
    }
    return ret;
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((pin==((void*)0))||(pin->pin>=8)||(log==((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
    {
        *log = ((*port_registers[pin->port] >> pin->pin) & (uint8)1);
    }
     return ret;
}
# 96 "MCAL_layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_write_logic(const pin_config *pin,logic_t log)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((pin==((void*)0))||(pin->pin>=8))
...
# 212 "MCAL_layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_read_logic(port_index port,uint8 *log)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((log==((void*)0)) ||(port>=5))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
# 233 "MCAL_layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_write_logic(port_index port,uint8 log)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(port>=5)
