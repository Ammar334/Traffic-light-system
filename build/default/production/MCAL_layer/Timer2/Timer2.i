...
# 12 "MCAL_layer/Timer2/../Interrupt/mcal_Interrupt_cfg.h"
...
# 12 "MCAL_layer/Timer2/../Interrupt/mcal_Interrupt_cfg.h" 2

# 1 "MCAL_layer/Timer2/../Interrupt/../mcal_std_types.h" 1
# 13 "MCAL_layer/Timer2/../Interrupt/../mcal_std_types.h"
# 1 "MCAL_layer/Timer2/../Interrupt/../compiler.h" 1
# 13 "MCAL_layer/Timer2/../Interrupt/../compiler.h"
...
# 13 "MCAL_layer/Timer2/../Interrupt/../compiler.h" 2
# 13 "MCAL_layer/Timer2/../Interrupt/../mcal_std_types.h" 2

# 1 "MCAL_layer/Timer2/../Interrupt/../std_libraries.h" 1
# 13 "MCAL_layer/Timer2/../Interrupt/../std_libraries.h"
...
# 13 "MCAL_layer/Timer2/../Interrupt/../std_libraries.h" 2
...
# 15 "MCAL_layer/Timer2/../Interrupt/../std_libraries.h" 2
...
# 16 "MCAL_layer/Timer2/../Interrupt/../std_libraries.h" 2
# 14 "MCAL_layer/Timer2/../Interrupt/../mcal_std_types.h" 2
...
# 13 "MCAL_layer/Timer2/../Interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/Timer2/../Interrupt/../GPIO/../device_config.h" 1
# 13 "MCAL_layer/Timer2/../Interrupt/../GPIO/hal_gpio.h" 2
# 29 "MCAL_layer/Timer2/../Interrupt/../GPIO/hal_gpio.h"
typedef enum
{
    GPIO_PIN0 =0,
    GPIO_PIN1 ,
...
# 51 "MCAL_layer/Timer2/../Interrupt/mcal_Interrupt_cfg.h"
typedef enum
{
    HIGH_PRIORTY,
    LOW_PRIORTY
...
Std_ReturnType Timer2_init(const Timer2_t *TM2_obj)
{
    ...
    {
        (T2CONbits.TMR2ON = 0);
        (T2CONbits.T2CKPS = TM2_obj->prescaler_value);
        (T2CONbits.TOUTPS = TM2_obj->postcaler_value);
        TMR2 = TM2_obj->preload_value;
        timer2_preload = TM2_obj->preload_value;

        (PIE1bits.TMR2IE = 1);
        (PIR1bits.TMR2IF = 0);
# 49 "MCAL_layer/Timer2/Timer2.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((TM2_obj == ((void*)0))||(value == ((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
void TIMER2_ISR (void)
{
    (PIR1bits.TMR2IF = 0);
    TMR2 = timer2_preload;
    if(Timer2InterruptHandeler != ((void*)0))
    {
