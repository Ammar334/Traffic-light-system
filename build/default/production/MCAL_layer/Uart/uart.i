...
# 1 "MCAL_layer/Uart/uart.h" 1
# 13 "MCAL_layer/Uart/uart.h"
# 1 "MCAL_layer/Uart/uart_cfg.h" 1
# 13 "MCAL_layer/Uart/uart.h" 2

# 1 "MCAL_layer/Uart/../Interrupt/mcal_internal_Interrupt.h" 1
# 13 "MCAL_layer/Uart/../Interrupt/mcal_internal_Interrupt.h"
# 1 "MCAL_layer/Uart/../Interrupt/mcal_Interrupt_cfg.h" 1
# 12 "MCAL_layer/Uart/../Interrupt/mcal_Interrupt_cfg.h"
...
# 12 "MCAL_layer/Uart/../Interrupt/mcal_Interrupt_cfg.h" 2

# 1 "MCAL_layer/Uart/../Interrupt/../mcal_std_types.h" 1
# 13 "MCAL_layer/Uart/../Interrupt/../mcal_std_types.h"
# 1 "MCAL_layer/Uart/../Interrupt/../compiler.h" 1
# 13 "MCAL_layer/Uart/../Interrupt/../compiler.h"
...
# 13 "MCAL_layer/Uart/../Interrupt/../compiler.h" 2
# 13 "MCAL_layer/Uart/../Interrupt/../mcal_std_types.h" 2

# 1 "MCAL_layer/Uart/../Interrupt/../std_libraries.h" 1
# 13 "MCAL_layer/Uart/../Interrupt/../std_libraries.h"
...
# 13 "MCAL_layer/Uart/../Interrupt/../std_libraries.h" 2
...
# 15 "MCAL_layer/Uart/../Interrupt/../std_libraries.h" 2
...
# 16 "MCAL_layer/Uart/../Interrupt/../std_libraries.h" 2
# 14 "MCAL_layer/Uart/../Interrupt/../mcal_std_types.h" 2
...
# 13 "MCAL_layer/Uart/../Interrupt/mcal_Interrupt_cfg.h" 2

# 1 "MCAL_layer/Uart/../Interrupt/mcal_Interrupt_gen_cfg.h" 1
# 14 "MCAL_layer/Uart/../Interrupt/mcal_Interrupt_cfg.h" 2

# 1 "MCAL_layer/Uart/../Interrupt/../GPIO/hal_gpio.h" 1
# 13 "MCAL_layer/Uart/../Interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/Uart/../Interrupt/../GPIO/../device_config.h" 1
# 13 "MCAL_layer/Uart/../Interrupt/../GPIO/hal_gpio.h" 2
# 29 "MCAL_layer/Uart/../Interrupt/../GPIO/hal_gpio.h"
typedef enum
{
    GPIO_PIN0 =0,
    GPIO_PIN1 ,
...
# 15 "MCAL_layer/Uart/../Interrupt/mcal_Interrupt_cfg.h" 2
# 51 "MCAL_layer/Uart/../Interrupt/mcal_Interrupt_cfg.h"
typedef enum
{
    HIGH_PRIORTY,
    LOW_PRIORTY
...
# 13 "MCAL_layer/Uart/../Interrupt/mcal_internal_Interrupt.h" 2
# 14 "MCAL_layer/Uart/uart.h" 2
# 83 "MCAL_layer/Uart/uart.h"
typedef enum
{
    ...
    else
    {
        switch(uart_obj->BuadRate_cfg)
        {
            case BUADRATE_ASSYNC_8BIT_LOW_SPEED:
                ...
                (TXSTAbits.BRGH = 0);
                (BAUDCONbits.BRG16 = 0);
                Baudrate_temp = ((4000000UL/uart_obj->BuadRate)/64)-1;
                break;
            case BUADRATE_ASSYNC_8BIT_HIGH_SPEED:
                (TXSTAbits.SYNC = 0);
                (TXSTAbits.BRGH = 1);
                (BAUDCONbits.BRG16 = 0);
                Baudrate_temp = ((4000000UL/uart_obj->BuadRate)/16)-1;
                break;
            ...
            case BUADRATE_ASSYNC_16BIT_HIGH_SPEED:
                ...
                (TXSTAbits.BRGH = 1);
                (BAUDCONbits.BRG16 = 1);
                Baudrate_temp = ((4000000UL/uart_obj->BuadRate)/4)-1;
                break;
...
static Std_ReturnType EUART_ASYNC_TX_Init(const uart_t *uart_obj)
{
    ...
    {
        if(uart_obj->uart_tx.uart_tx_enable == 1)
        {
            if(uart_obj->uart_tx.uart_tx_Interrubt_enable == 1)
            {

                (PIE1bits.TXIE = 1);
# 243 "MCAL_layer/Uart/uart.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
            ...
            else if(uart_obj->uart_tx.uart_tx_Interrubt_enable == 0)
            {
            ...
            if(uart_obj->uart_tx.uart_tx_9bit_enable == 1)
            {
                (TXSTAbits.TX9 = 1);
            }
            else if(uart_obj->uart_tx.uart_tx_9bit_enable == 0)
            {
                (TXSTAbits.TX9 = 0);
            }
            else
...
static Std_ReturnType EUART_ASYNC_RX_Init(const uart_t *uart_obj)
{
    ...
    {
        if(uart_obj->uart_rx.uart_rx_enable == 1)
        {


            if(uart_obj->uart_rx.uart_rx_Interrubt_enable == 1)
            {


                (PIE1bits.RCIE = 1);
# 317 "MCAL_layer/Uart/uart.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
            ...
            else if(uart_obj->uart_rx.uart_rx_Interrubt_enable == 0)
            {
...
void EUSART_RX_ISR (void)
{
    ...
    if(Uart_RX_CallBack != ((void*)0))
    {
        Uart_RX_CallBack();
    }
    else{ }
    if(Uart_FRAMING_CallBack != ((void*)0))
    {
        Uart_FRAMING_CallBack();
    }
    else{ }
    if(Uart_OVERRUN_CallBack != ((void*)0))
    {
