...
# 1 "MCAL_layer/Timer1/Timer1_cfg.h" 1
...
# 12 "MCAL_layer/Timer1/../Interrupt/mcal_Interrupt_cfg.h"
...
# 12 "MCAL_layer/Timer1/../Interrupt/mcal_Interrupt_cfg.h" 2

# 1 "MCAL_layer/Timer1/../Interrupt/../mcal_std_types.h" 1
# 13 "MCAL_layer/Timer1/../Interrupt/../mcal_std_types.h"
# 1 "MCAL_layer/Timer1/../Interrupt/../compiler.h" 1
# 13 "MCAL_layer/Timer1/../Interrupt/../compiler.h"
...
# 13 "MCAL_layer/Timer1/../Interrupt/../compiler.h" 2
# 13 "MCAL_layer/Timer1/../Interrupt/../mcal_std_types.h" 2

# 1 "MCAL_layer/Timer1/../Interrupt/../std_libraries.h" 1
# 13 "MCAL_layer/Timer1/../Interrupt/../std_libraries.h"
...
# 13 "MCAL_layer/Timer1/../Interrupt/../std_libraries.h" 2
...
# 15 "MCAL_layer/Timer1/../Interrupt/../std_libraries.h" 2
...
# 16 "MCAL_layer/Timer1/../Interrupt/../std_libraries.h" 2
# 14 "MCAL_layer/Timer1/../Interrupt/../mcal_std_types.h" 2
...
# 1 "MCAL_layer/Timer1/../Interrupt/../GPIO/hal_gpio.h" 1
# 13 "MCAL_layer/Timer1/../Interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/Timer1/../Interrupt/../GPIO/../device_config.h" 1
# 13 "MCAL_layer/Timer1/../Interrupt/../GPIO/hal_gpio.h" 2
# 29 "MCAL_layer/Timer1/../Interrupt/../GPIO/hal_gpio.h"
typedef enum
{
    GPIO_PIN0 =0,
    GPIO_PIN1 ,
...
# 51 "MCAL_layer/Timer1/../Interrupt/mcal_Interrupt_cfg.h"
typedef enum
{
    HIGH_PRIORTY,
    LOW_PRIORTY
...
# 1 "MCAL_layer/Timer1/../Interrupt/mcal_external_Interrupt.h" 1
# 72 "MCAL_layer/Timer1/../Interrupt/mcal_external_Interrupt.h"
typedef enum
{
    EXT_INT0,
    EXT_INT1,
...
Std_ReturnType Timer1_init(const Timer1_t *TM1_obj)
{
    ...
    {
        (T1CONbits.TMR1ON = 0);
        (T1CONbits.TMR1CS = TM1_obj->Timer1_MODE);
        if(TM1_obj->Timer1_MODE == 1)
        {
            (T1CONbits.T1SYNC = TM1_obj->Timer1_Counter_Mode_SYNC);
        }

        (T1CONbits.RD16 = TM1_obj->Timer1_wr_register_size);
        (T1CONbits.T1CKPS = TM1_obj->prescaler_value);
...
Std_ReturnType Timer1_Read_Value(const Timer1_t *TM1_obj,uint16 *value)
{
    ...
    uint8 l_timerh =0 ;
    uint8 l_timerl =0 ;
    if((TM1_obj == ((void*)0))||(value == ((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
void TIMER1_ISR (void)
{
    ...
    if(Timer1InterruptHandeler != ((void*)0))
    {
