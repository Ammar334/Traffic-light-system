...
# 1 "MCAL_layer/CCP/CCP1.h" 1
# 13 "MCAL_layer/CCP/CCP1.h"
# 1 "MCAL_layer/CCP/CCP1_cfg.h" 1
# 13 "MCAL_layer/CCP/CCP1.h" 2
...
# 12 "MCAL_layer/CCP/../Interrupt/mcal_Interrupt_cfg.h"
...
# 12 "MCAL_layer/CCP/../Interrupt/mcal_Interrupt_cfg.h" 2

# 1 "MCAL_layer/CCP/../Interrupt/../mcal_std_types.h" 1
# 13 "MCAL_layer/CCP/../Interrupt/../mcal_std_types.h"
# 1 "MCAL_layer/CCP/../Interrupt/../compiler.h" 1
# 13 "MCAL_layer/CCP/../Interrupt/../compiler.h"
...
# 13 "MCAL_layer/CCP/../Interrupt/../compiler.h" 2
# 13 "MCAL_layer/CCP/../Interrupt/../mcal_std_types.h" 2

# 1 "MCAL_layer/CCP/../Interrupt/../std_libraries.h" 1
# 13 "MCAL_layer/CCP/../Interrupt/../std_libraries.h"
...
# 13 "MCAL_layer/CCP/../Interrupt/../std_libraries.h" 2
...
# 15 "MCAL_layer/CCP/../Interrupt/../std_libraries.h" 2
...
# 16 "MCAL_layer/CCP/../Interrupt/../std_libraries.h" 2
# 14 "MCAL_layer/CCP/../Interrupt/../mcal_std_types.h" 2
...
# 13 "MCAL_layer/CCP/../Interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/CCP/../Interrupt/../GPIO/../device_config.h" 1
# 13 "MCAL_layer/CCP/../Interrupt/../GPIO/hal_gpio.h" 2
# 29 "MCAL_layer/CCP/../Interrupt/../GPIO/hal_gpio.h"
typedef enum
{
    GPIO_PIN0 =0,
    GPIO_PIN1 ,
...
# 15 "MCAL_layer/CCP/../Interrupt/mcal_Interrupt_cfg.h" 2
# 51 "MCAL_layer/CCP/../Interrupt/mcal_Interrupt_cfg.h"
typedef enum
{
    HIGH_PRIORTY,
    LOW_PRIORTY
...
# 14 "MCAL_layer/CCP/CCP1.h" 2
# 68 "MCAL_layer/CCP/CCP1.h"
typedef enum
{
    ...
    else
    {
        ...
        if(ccp_obj->cpp_mode == CCP_CAPTURE_MODE_SELECT)
        {
            ...
            if(ccp_obj->ccp_inst == CCP1_inst)
            {
                ...
                {
                    case (uint8)4:
                        (CCP1CONbits.CCP1M = (uint8)4);
                        break;
                    case (uint8)5:
                        (CCP1CONbits.CCP1M = (uint8)5);
                        break;
                    case (uint8)6:
                        (CCP1CONbits.CCP1M = (uint8)6);
                        break;
                    case (uint8)7:
                        (CCP1CONbits.CCP1M = (uint8)7);
                        break;
                    default :
                        ret = (Std_ReturnType)0x00;
                }
            ...
            else if(ccp_obj->ccp_inst == CCP2_inst)
            {
                ...
                {
                    case (uint8)4:
                        (CCP2CONbits.CCP2M = (uint8)4);
                        break;
                    case (uint8)5:
                        (CCP2CONbits.CCP2M = (uint8)5);
                        break;
                    case (uint8)6:
                        (CCP2CONbits.CCP2M = (uint8)6);
                        break;
                    case (uint8)7:
                        (CCP2CONbits.CCP2M = (uint8)7);
                        break;
                    default :
                        ret = (Std_ReturnType)0x00;
                }
        ...
        else if(ccp_obj->cpp_mode == CCP_COMPARE_MODE_SELECT)
        {
            ...
            if(ccp_obj->ccp_inst == CCP1_inst)
            {
                ...
                {
                    case (uint8)2:
                        (CCP1CONbits.CCP1M = (uint8)2);
                        break;
                    case (uint8)8:
                        (CCP1CONbits.CCP1M = (uint8)8);
                        break;
                    case (uint8)9:
                        (CCP1CONbits.CCP1M = (uint8)9);
                        break;
                    case (uint8)10:
                        (CCP1CONbits.CCP1M = (uint8)10);
                        break;
                    case (uint8)11:
                        (CCP1CONbits.CCP1M = (uint8)11);
                        break;
                    default :
                        ret = (Std_ReturnType)0x00;
                }
            ...
            else if(ccp_obj->ccp_inst == CCP2_inst)
            {
                ...
                {
                    case (uint8)2:
                        (CCP2CONbits.CCP2M = (uint8)2);
                        break;
                    case (uint8)8:
                        (CCP2CONbits.CCP2M = (uint8)8);
                        break;
                    case (uint8)9:
                        (CCP2CONbits.CCP2M = (uint8)9);
                        break;
                    case (uint8)10:
                        (CCP2CONbits.CCP2M = (uint8)10);
                        break;
                    case (uint8)11:
                        (CCP2CONbits.CCP2M = (uint8)11);
                        break;
                    default :
                        ret = (Std_ReturnType)0x00;
                }
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((ccp_obj == ((void*)0))||(capture_status == ((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
Std_ReturnType CCP1_Capture_read_value(const CCP_t *ccp_obj,uint16 *Capture_value)
{
    ...
    if((ccp_obj == ((void*)0))||(Capture_value == ((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((ccp_obj == ((void*)0))||(Compare_status == ((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
# 439 "MCAL_layer/CCP/CCP1.c"
void CCP1_ISR (void)
{
    (PIR1bits.CCP1IF = 0);
    if(CCP1_InterruptHandeler != ((void*)0))
    {
...
{
    (PIR2bits.CCP2IF = 0);
    if(CCP2_InterruptHandeler != ((void*)0))
    {
