...
# 13 "MCAL_layer/Timer0/../GPIO/../mcal_std_types.h"
# 1 "MCAL_layer/Timer0/../GPIO/../compiler.h" 1
# 13 "MCAL_layer/Timer0/../GPIO/../compiler.h"
...
# 15 "MCAL_layer/Timer0/../GPIO/../std_libraries.h" 2
...
# 16 "MCAL_layer/Timer0/../GPIO/../std_libraries.h" 2
# 14 "MCAL_layer/Timer0/../GPIO/../mcal_std_types.h" 2
...
# 29 "MCAL_layer/Timer0/../GPIO/hal_gpio.h"
typedef enum
{
    GPIO_PIN0 =0,
    GPIO_PIN1 ,
...
# 51 "MCAL_layer/Timer0/../Interrupt/mcal_Interrupt_cfg.h"
typedef enum
{
    HIGH_PRIORTY,
    LOW_PRIORTY
...
# 15 "MCAL_layer/Timer0/Timer0.h" 2
...
# 7 "MCAL_layer/Timer0/Timer0.c" 2
...
Std_ReturnType Timer0_Read_Value(const TIMER0_t *TM0_obj,uint16 *value)
{
    ...
    if((TM0_obj == ((void*)0))||(value == ((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
static Std_ReturnType Timer0_Mode_select(const TIMER0_t *TM0_obj)
{
    ...
    else
    {
        switch(TM0_obj->Timer0_MODE)
        {
            case 1 :
                (T0CONbits.T0CS = 1);
                (T0CONbits.T0SE = TM0_obj->Timer0_counter_EDGE);
                break;
            case 0 :
                (T0CONbits.T0CS = 0);
                break;
...
static Std_ReturnType Timer0_Prescaler_select(const TIMER0_t *TM0_obj)
{
    ...
    else
    {
        switch(TM0_obj->prescaler_Enable)
        {
            case 1:
                (T0CONbits.PSA = 0);
                (T0CONbits.T0PS = TM0_obj->prescaler_value);
                break;
            case 0:
                (T0CONbits.PSA = 1);
                break;
...
void TIMER0_ISR (void)
{
    ...
    if(Timer0InterruptHandeler != ((void*)0))
    {
