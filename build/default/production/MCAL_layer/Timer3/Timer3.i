...
# 12 "MCAL_layer/Timer3/../Interrupt/mcal_Interrupt_cfg.h"
...
# 12 "MCAL_layer/Timer3/../Interrupt/mcal_Interrupt_cfg.h" 2

# 1 "MCAL_layer/Timer3/../Interrupt/../mcal_std_types.h" 1
# 13 "MCAL_layer/Timer3/../Interrupt/../mcal_std_types.h"
# 1 "MCAL_layer/Timer3/../Interrupt/../compiler.h" 1
# 13 "MCAL_layer/Timer3/../Interrupt/../compiler.h"
...
# 15 "MCAL_layer/Timer3/../Interrupt/../std_libraries.h" 2
...
# 16 "MCAL_layer/Timer3/../Interrupt/../std_libraries.h" 2
# 14 "MCAL_layer/Timer3/../Interrupt/../mcal_std_types.h" 2
...
# 13 "MCAL_layer/Timer3/../Interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/Timer3/../Interrupt/../GPIO/../device_config.h" 1
# 13 "MCAL_layer/Timer3/../Interrupt/../GPIO/hal_gpio.h" 2
# 29 "MCAL_layer/Timer3/../Interrupt/../GPIO/hal_gpio.h"
typedef enum
{
    GPIO_PIN0 =0,
    GPIO_PIN1 ,
...
# 51 "MCAL_layer/Timer3/../Interrupt/mcal_Interrupt_cfg.h"
typedef enum
{
    HIGH_PRIORTY,
    LOW_PRIORTY
...
# 7 "MCAL_layer/Timer3/Timer3.c" 2
...
Std_ReturnType Timer3_init(const Timer3_t *TM3_obj)
{
    ...
    {
        (T3CONbits.TMR3ON = 0);
        (T3CONbits.T3CKPS = TM3_obj->prescaler_value);
        (T3CONbits.TMR3CS = TM3_obj->Timer3_MODE);
        if(TM3_obj->Timer3_MODE == 1)
        {
            (T3CONbits.T3SYNC = TM3_obj->Timer3_Counter_Mode_SYNC);
        }
        (T3CONbits.RD16 = TM3_obj->Timer3_wr_register_size);
...
Std_ReturnType Timer3_Read_Value(const Timer3_t *TM3_obj,uint16 *value)
{
    ...
    uint8 l_timerh =0 ;
    uint8 l_timerl =0 ;
    if((TM3_obj == ((void*)0))||(value == ((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
void TIMER3_ISR (void)
{
    ...
    if(Timer3InterruptHandeler != ((void*)0))
    {
