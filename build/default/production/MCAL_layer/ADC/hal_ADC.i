...
# 13 "MCAL_layer/ADC/hall_ADC.h" 2
...
# 15 "MCAL_layer/ADC/hall_ADC.h" 2
...
# 51 "MCAL_layer/ADC/../Interrupt/mcal_Interrupt_cfg.h"
typedef enum
{
    HIGH_PRIORTY,
    LOW_PRIORTY
...
# 16 "MCAL_layer/ADC/hall_ADC.h" 2

# 1 "MCAL_layer/ADC/../Interrupt/mcal_external_Interrupt.h" 1
# 72 "MCAL_layer/ADC/../Interrupt/mcal_external_Interrupt.h"
typedef enum
{
    EXT_INT0,
    EXT_INT1,
...
# 17 "MCAL_layer/ADC/hall_ADC.h" 2
...
Std_ReturnType ADC_init(const ADC_t* ADC_obj)
{
    ...
    else
    {
        ...
        (ADCON2bits.ADCS = ADC_obj->Prescaler);
...
# 61 "MCAL_layer/ADC/hal_ADC.c"
        ...
        (ADCON2bits.ADFM = ADC_obj->Result_format);

        if(ADC_obj->voltage_refrence == 1U)
        {
            do{ADCON1bits.VCFG0 = 0; ADCON1bits.VCFG1 = 0; }while(0);
        }
        else if(ADC_obj->voltage_refrence == 0U)
        {
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((ADC_obj == ((void*)0))||(conversion_status == ((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((ADC_obj == ((void*)0))||(Resualt == ((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
    {
        if(ADC_obj->Result_format == 1U)
        {

            *Resualt = ((*((volatile uint16*)(0xFC3))));
        }
        else if(ADC_obj->Result_format == 0U)
        {
...
{
    (PIR1bits.ADIF = 0);
    if(ADC_InterruptCallBack != ((void*)0))
    {
