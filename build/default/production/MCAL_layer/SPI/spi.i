...
# 12 "MCAL_layer/SPI/../Interrupt/mcal_Interrupt_cfg.h"
...
# 12 "MCAL_layer/SPI/../Interrupt/mcal_Interrupt_cfg.h" 2

# 1 "MCAL_layer/SPI/../Interrupt/../mcal_std_types.h" 1
# 13 "MCAL_layer/SPI/../Interrupt/../mcal_std_types.h"
# 1 "MCAL_layer/SPI/../Interrupt/../compiler.h" 1
# 13 "MCAL_layer/SPI/../Interrupt/../compiler.h"
...
# 13 "MCAL_layer/SPI/../Interrupt/../compiler.h" 2
# 13 "MCAL_layer/SPI/../Interrupt/../mcal_std_types.h" 2

# 1 "MCAL_layer/SPI/../Interrupt/../std_libraries.h" 1
# 13 "MCAL_layer/SPI/../Interrupt/../std_libraries.h"
...
# 13 "MCAL_layer/SPI/../Interrupt/../std_libraries.h" 2
...
# 15 "MCAL_layer/SPI/../Interrupt/../std_libraries.h" 2
...
# 16 "MCAL_layer/SPI/../Interrupt/../std_libraries.h" 2
# 14 "MCAL_layer/SPI/../Interrupt/../mcal_std_types.h" 2
...
# 1 "MCAL_layer/SPI/../Interrupt/../GPIO/hal_gpio.h" 1
# 13 "MCAL_layer/SPI/../Interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/SPI/../Interrupt/../GPIO/../device_config.h" 1
# 13 "MCAL_layer/SPI/../Interrupt/../GPIO/hal_gpio.h" 2
# 29 "MCAL_layer/SPI/../Interrupt/../GPIO/hal_gpio.h"
typedef enum
{
    GPIO_PIN0 =0,
    GPIO_PIN1 ,
...
# 15 "MCAL_layer/SPI/../Interrupt/mcal_Interrupt_cfg.h" 2
# 51 "MCAL_layer/SPI/../Interrupt/mcal_Interrupt_cfg.h"
typedef enum
{
    HIGH_PRIORTY,
    LOW_PRIORTY
...
Std_ReturnType SPI_Master_Init(const SPI_t *spi_obj)
{
    ...
    else
    {
        ...
        (SSPCON1bits.CKP = spi_obj->spi_CLK_Polarity);
        (SSPSTATbits.CKE = spi_obj->spi_transmit_time);
        (SSPSTATbits.SMP = spi_obj->spi_sample_time);


        (PIE1bits.SSPIE = 1);
        (PIR1bits.SSPIF = 0);
# 61 "MCAL_layer/SPI/spi.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((spi_obj == ((void*)0))||(value == ((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
Std_ReturnType SPI_Write_NotBlocking(const SPI_t *spi_obj,uint8 value)
{
    ...
    {
        if(((SSPSTATbits.BF)==1) || ((PIR1bits.SSPIF) == 0))
        {
            SSPBUF = value;
            PIR1bits.SSPIF = 0;
        }
...
Std_ReturnType SPI_Write_String_Blocking(const SPI_t *spi_obj,uint8 *string)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_counter = 0;
    if((spi_obj == ((void*)0))&&(string == ((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
